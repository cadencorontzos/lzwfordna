...
```{r, echo=F}
df11 = read.csv("./DNACorpus1Run.csv")
df21 = read.csv("./DNACorpus2Run.csv")
...
corpus_1 %>% 
  ggplot(aes(x=run))+
  geom_line(aes(y=Compresssion.Time, color = "blue"))+
  geom_line(aes(y=Decompression.Time, color= "red"))+
...
corpus_2 %>% 
  ggplot(aes(x=run))+
  geom_line(aes(y=Compresssion.Time, color = "blue"))+
  geom_line(height =1, aes(y=Decompression.Time, color= "red"))+
