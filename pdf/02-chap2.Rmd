...
Yet another paper made use of Chinese Remainder Theorem to augment Lempel Ziv Welch [@ibrahimgbolagade]. They saw great reduction in compression time without comprimising compression ratio, although these results could not be verified.

**TODO**: Talk about how we tried to get in touch with the authors.
...
**TODO**: style and put histogram here. Too large to include it programatically
...
Here is the data for this version of the dictionary.

```{r, echo = F}
stats_csv('data/stats/corpus_1_directmap_154fed4.csv')
stats_csv('data/stats/corpus_2_directmap_154fed4.csv')
```
...
Similar to the Direct Mapped approach, we use dictionaries for each string size up to a certain size `n` , and for all strings of length greater than `n`, we use a regular dictionary. 

Here are the results for this dictionary. 

```{r, echo = F}
stats_csv('data/stats/corpus_1_multstddict_154fed4.csv')
stats_csv('data/stats/corpus_2_multstddict_154fed4.csv')
```
...
compare_coprora(list(
  ...
  c('data/stats/corpus_1_multstddict_154fed4.csv', 'data/stats/corpus_2_multstddict_154fed4.csv', 'Multiple Indexed Dictionaries')
  ))
...
compare_coprora(list(
  c('data/stats/corpus_1_stddict_68bea3d.csv', 'data/stats/corpus_2_stddict_68bea3d.csv', 'Standard Dictionary'),
  c('data/stats/corpus_1_directmap_154fed4.csv', 'data/stats/corpus_2_directmap_154fed4.csv', 'Direct Map'),
  c('data/stats/corpus_1_multstddict_154fed4.csv', 'data/stats/corpus_2_multstddict_154fed4.csv', 'Multiple Indexed Dictionaries')
  ))
