...
\hypertarget{techniques-used}{%
\section{Techniques Used}\label{techniques-used}}

I used several programming tools in order to access and optimize my code.

\hypertarget{valgrind-and-callgrind}{%
\subsection{Valgrind and Callgrind}\label{valgrind-and-callgrind}}

\hypertarget{gprof}{%
\subsection{gprof}\label{gprof}}
