...
\caption{\label{tab:fixedeofstatsfig}F}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:usingconstantsstatsfig}F}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrr}
\toprule
...
\caption{\label{tab:stringconcatstatsfig}F}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrr}
\toprule
...
\caption{\label{tab:dictaccessesstatsfig}F}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrr}
\toprule
...
\caption{\label{tab:charstarstatsfig}F}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrr}
\toprule
...
\caption{\label{tab:directmaplength10statsfig}F}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrr}
\toprule
...
\caption{\label{tab:multdictlength10statsfig}F}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrr}
\toprule
