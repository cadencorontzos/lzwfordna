...
```{r comparisonofourmethodsfig, warnings= F, messages = F, fig.cap = "Performance comparison of our final implementations.", fig.height = 5, echo = F}
...
```{r decompcomparisonofourmethodsfig, warnings= F, messages = F, fig.cap = "Average Decompression time of our final implementations.", fig.height = 5, fig.width = 4, fig.align="center", echo = F}
...
```{r othertoolsgraphfig, warnings= F, messages = F, fig.cap = "Average compression time of other methods and our final implementations.", fig.height = 5, echo = F}

summary <- wholedf %>% 
  group_by(Program) %>% 
  reframe(
    comp_throughput = sum(Original.File.Size)/1024/sum(Compression.Time),
