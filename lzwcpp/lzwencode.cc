...
int main(int argc, char* argv[]){
	...
	if(fileInfo.st_size == 0){
		std::cout << "File" << argv[1] << " is empty. That's about as small as it will get." << std::endl;
		return 1;
	}
    ...
    std::cout << "Compression Ratio : " << compressionRatio(output_size, fileInfo.st_size) << std::endl;
