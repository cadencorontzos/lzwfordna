...
std::string empty_expected_output() {
  ...
  std::stringstream bits;
  {
    BitOutput bito(bits);
    // eof
    bito.output_n_bits(codeword_helper.EOF_CODEWORD,
...
std::string three_chars_expected_output() {
  ...
  std::stringstream bits;
  {
    ...
    // cw for AG
    bito.output_n_bits(codeword_helper.get_next_codeword(),
                       codeword_helper.bits_per_codeword);
